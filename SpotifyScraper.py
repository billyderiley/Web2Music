...
class SpotifyScraper():
    ...
    @staticmethod
    def get_spotify_metadata_from_track(track, album_name=None, album_release_date=None):
        # print(track.keys())
        ...
        metadata = {
            ...
            'Spotify_Release_Date': track.get('album').get('release_date',
                                                           'Unknown Release Date') if album_release_date is None else album_release_date,
